...
mkdir /data/users/mvisani/genome_assembly/evaluation/busco/flye/unpolished
cd /data/users/mvisani/genome_assembly/evaluation/busco/flye/unpolished

OUTDIR=/data/users/mvisani/genome_assembly/evaluation/busco/flye/unpolished
WORKDIR=/data/users/mvisani/genome_assembly/
INPUT=/data/users/mvisani/genome_assembly/assembly/pacbio_flye/assembly.fasta
...
echo "busco \
    ...
    --out flye_unpolished " > eval_canu.sh
